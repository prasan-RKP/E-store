...
const Dup = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: "slipOn", name: "slipOn", count: 22 },
    { id: "sandal", name: "sandal", count: 18 },
    { id: "unisex", name: "unisex", count: 18 },
  ], []);
  ...
  // Discount options
  const discountOptions = useMemo(() => ["10%", "20%", "30%", "40%", "50%+"], []);
  ...
  const toggleGender = useCallback((gen) => {
    if (selectGender === gen) {
  ...
  const toggleDiscount = useCallback((discount) => {
  ...
  const filteredProducts = useMemo(() => {
    return allProducts.filter((product) => {
      ...
      // Gender Filter
      const matchesGender =
        selectGender.length === 0 || selectGender.includes(product.gender);
          ...
          <div className="hidden md:block w-64 flex-shrink-0">
            <div className="sticky top-24">
              ...
              <div className="bg-[#302b4d] bg-opacity-5 backdrop-blur-sm rounded-2xl p-5 mb-6">
                <h2 className="text-xl font-bold text-white mb-4">Gender</h2>
