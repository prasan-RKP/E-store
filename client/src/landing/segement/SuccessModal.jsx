...
import {
  FiCheck, FiX, FiPackage, FiMapPin, FiMail, FiPhone, FiCopy,
  FiDownload, FiEye, FiShare2, FiMessageCircle, FiZap, FiClock, FiTruck
} from 'react-icons/fi';
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold capitalize">
                        {orderData?.verifiedUser?.paymentMethod}
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      {orderData?.verifiedUser?.city}, {orderData?.verifiedUser?.state},{" "}
                      {orderData?.verifiedUser?.zipCode}
                    </p>
