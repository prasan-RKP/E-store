      ...
      () => [
        {
          id: 1,
          image:
            "https://img.freepik.com/free-psd/end-season-summer-sale-social-media-banner-post-template_47987-14117.jpg?uid=R201647660&ga=GA1.1.609031703.1716957572&semt=ais_hybrid&w=740",
        ...
        },
        {
          id: 2,
          image:
            "https://img.freepik.com/premium-photo/exclusive-fashion-deals-background-web-banner_1280472-3554.jpg?uid=R201647660&ga=GA1.1.609031703.1716957572&semt=ais_hybrid&w=740",
          title: "Premium Denim",
        ...
        },
        {
          id: 3,
          image:
            "https://img.freepik.com/free-psd/shoes-sale-social-media-post-template-design_505751-4476.jpg?uid=R201647660&ga=GA1.1.609031703.1716957572&semt=ais_hybrid&w=740",
          title: "New Arrivals",
        ...
        },
        {
          id: 4,
          image:
            "https://img.freepik.com/premium-vector/advertising-banner-poster-design-with-beautiful-young-girl_1302-18069.jpg?uid=R201647660&ga=GA1.1.609031703.1716957572&semt=ais_hybrid&w=740",
          title: "Spring Sale",
  ...
  const allProducts = useMemo(() => [
    {
      ...
      discount: 0,
      gender: "m",
      desc: "The Nike Jordon Air-7 blends classic design with modern comfort. Built for style and agility, this sneaker delivers excellent traction and cushioning. Ideal for casual outings or athletic wear.",
      new: false,
      sale: false,
    },
    {
      _id: "6817786d1378ddc94388de74",
      uid: "p2",
      ...
      discount: 4,
      gender: "m",
      desc: "Bold and stylish, the Nike Pink Air-9 stands out with its vibrant color and supportive structure. Built for all-day comfort and breathability.",
      new: false,
      sale: false,
    },
    {
      _id: "6817786d1378ddc94388de75",
      uid: "p3",
      name: "Nike White Leather Sneaker",
      category: "sneaker",
      price: 1739.29,
      img: "https://res.cloudinary.com/dlkmhoueb/image/upload/v1745644620/ecom_store/footwear/gorckzpeemmwlbkexu7a.jpg",
      rating: 4.1,
      reviewCount: 190,
      sizes: ["7", "8", "9", "10"],
      discount: 0,
      gender: "m",
      desc: "Crafted from premium white leather, this Nike sneaker brings elegance to everyday footwear. Durable yet sleek, it's versatile enough for both casual and semi-formal wear.",
      new: true,
      sale: false,
    },
    {
      _id: "6817786d1378ddc94388de76",
      uid: "p4",
      ...
      discount: 2,
      gender: "m",
      desc: "Combining timeless black and white styling with modern sneaker technology, the JD/2 offers ultimate comfort and street-ready fashion.",
      new: false,
      sale: false,
    },
    {
      _id: "6817786d1378ddc94388de77",
      uid: "p5",
      ...
      discount: 0,
      gender: "m",
      desc: "Vibrant and energetic, the yellow Nike JD/2ev is designed for bold personalities. Comfortable, breathable, and built for attention.",
      new: false,
      sale: false,
    },
    {
      _id: "6817786d1378ddc94388de78",
      uid: "p6",
      ...
      discount: 0,
      gender: "m",
      desc: "With a unique greenish hue, this Nike Air sneaker delivers comfort and style. Ideal for casual wear with maximum impact.",
      new: true,
      sale: false,
    },
    {
      _id: "6817786d1378ddc94388de79",
      uid: "p7",
      ...
      discount: 0,
      gender: "m",
      desc: "Sleek and comfortable Addidas Black Casuals. Minimal, modern design crafted for everyday use.",
      new: false,
      sale: false,
    },
    {
      _id: "6817786d1378ddc94388de80",
      uid: "p8",
      ...
      discount: 5,
      gender: "m",
      desc: "Fresh and minimal, this Puma white casual shoe is perfect for clean everyday fashion. Crafted for comfort and versatility.",
      new: false,
      sale: false,
    },
  ], []);
                    ...
                    <div className="flex flex-wrap gap-2">
                      {genderOptions.map((gen) => (
                        <button
                          ...
                          className={`flex items-center justify-center w-20 h-12 rounded-lg text-black transition-colors ${
                            selectGender === gen
                              ? "bg-primary"
                              : "bg-white bg-opacity-10 hover:bg-gray-500 hover:text-gray-300 hover:bg-opacity-20"
                          }`}
                        >
                          {gen}
                        </button>
                    ...
                    >
                            ...
                            <div className="flex text-yellow-400 mr-1">
                              {Array.from({ length: 5 }).map((_, index) => (
                                <Star
                                  ...
                                  fill={
                                    index < product.rating ? "#FACC15" : "none"
                                  }
                                />
                              ))}
                            </div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="relative mb-4">
                          ...
                          {dropdownOpen === product?._id && (
                            <div className="absolute bottom-full mb-2 bg-slate-900 border border-gray-300 rounded-md shadow-lg w-full max-h-48 overflow-y-auto z-10">
